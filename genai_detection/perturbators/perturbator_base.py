...
class PerturbatorBase:
    ...
    def _perturb_impl(self, text: Iterable[str], n_variants: int) -> Iterable[str]:
        """
    ...
    def _generate_and_cache(self, text: Iterable[str], n_variants: int, write_cache: bool):
    ...
    def _get_cached(self, text: Iterable[str], n_variants: int):
    ...
    def perturb(self, text: Union[str, Iterable[str]], n_variants: int = 1) -> Union[str, List[str]]:
        """
